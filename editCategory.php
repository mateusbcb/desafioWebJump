<?php
  ...
  $findCategoria = $categorias->select($id);
?>
...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form action="routes/atualizarCategoria.php" method="POST">
      <input type="hidden" name="id" value="<?php echo $findCategoria[0]['id'] ?>">

      <div class="input-field">
        <label for="category-name" class="label">Category Name</label>
        <input type="text" id="category-name" name="nome" value="<?php echo $findCategoria[0]['nome'] ?>" class="input-text" />
        
      </div>
      <div class="input-field">
        <label for="category-code" class="label">Category Code</label>
        <input type="text" id="category-code" name="codigo" value="<?php echo $findCategoria[0]['codigo'] ?>" class="input-text" />
